...
class ISTFTHead(FourierHead):
    ...
    def forward(
        self, x: torch.Tensor, return_spec: bool = False, **kwargs
        ...
        Args:
            x (Tensor): Input tensor of shape (B, L, H), where B is the batch size,
                        L is the sequence length, and H denotes the model dimension.
            return_spec (bool): If true, returns audio, magnitude and phase. Defaults to False.

        Returns:
            Tensor or Tuple: Reconstructed time-domain audio signal, and optionally magnitude and phase.
        """
